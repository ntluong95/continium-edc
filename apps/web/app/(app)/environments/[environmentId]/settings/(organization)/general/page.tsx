...
import { FB_LOGO_URL, IS_CONTINIUM_CLOUD, IS_STORAGE_CONFIGURED } from "@/lib/constants";
import { getUser } from "@/lib/user/service";
import { getTranslate } from "@/lingodotdev/server";
import { getIsMultiOrgEnabled, getWhiteLabelPermission } from "@/modules/license-check/lib/utils";
...
const Page = async (props: { params: Promise<{ environmentId: string }> }) => {
  ...
  return (
    <PageContentWrapper>
      ...
      {!IS_CONTINIUM_CLOUD && <SecurityListTip />}
      <SettingsCard
      ...
      <div className="space-y-2">
        ...
        <IdBadge id={packageJson.version} label={t("common.continium_version")} variant="column" />
      </div>
    </PageContentWrapper>
  );
};
