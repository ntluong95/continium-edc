  ...
  return [
    {
      ...
      docsUrl:
        "https://continium.com/docs/self-hosting/advanced/enterprise-features/contact-management-segments",
    },
    {
      key: "projects",
      labelKey: t("environments.settings.enterprise.license_feature_projects"),
      docsUrl: "https://continium.com/docs/self-hosting/advanced/license",
    },
    {
      key: "whitelabel",
      labelKey: t("environments.settings.enterprise.license_feature_whitelabel"),
      docsUrl:
        "https://continium.com/docs/self-hosting/advanced/enterprise-features/whitelabel-email-follow-ups",
    },
    {
      key: "removeBranding",
      labelKey: t("environments.settings.enterprise.license_feature_remove_branding"),
      docsUrl:
        "https://continium.com/docs/self-hosting/advanced/enterprise-features/hide-powered-by-continium",
    },
    {
      key: "twoFactorAuth",
      labelKey: t("environments.settings.enterprise.license_feature_two_factor_auth"),
      docsUrl: "https://continium.com/docs/xm-and-surveys/core-features/user-management/two-factor-auth",
    },
    {
      key: "sso",
      labelKey: t("environments.settings.enterprise.license_feature_sso"),
      docsUrl: "https://continium.com/docs/self-hosting/advanced/enterprise-features/oidc-sso",
    },
    {
      key: "saml",
      labelKey: t("environments.settings.enterprise.license_feature_saml"),
      docsUrl: "https://continium.com/docs/self-hosting/advanced/enterprise-features/saml-sso",
    },
    {
      key: "spamProtection",
      labelKey: t("environments.settings.enterprise.license_feature_spam_protection"),
      docsUrl: "https://continium.com/docs/xm-and-surveys/surveys/general-features/spam-protection",
    },
    {
      key: "auditLogs",
      labelKey: t("environments.settings.enterprise.license_feature_audit_logs"),
      docsUrl: "https://continium.com/docs/self-hosting/advanced/enterprise-features/audit-logging",
    },
    {
      key: "accessControl",
      labelKey: t("environments.settings.enterprise.license_feature_access_control"),
      docsUrl: "https://continium.com/docs/self-hosting/advanced/enterprise-features/team-access",
    },
    {
      key: "quotas",
      labelKey: t("environments.settings.enterprise.license_feature_quotas"),
      docsUrl: "https://continium.com/docs/xm-and-surveys/surveys/general-features/quota-management",
    },
  ];
};
