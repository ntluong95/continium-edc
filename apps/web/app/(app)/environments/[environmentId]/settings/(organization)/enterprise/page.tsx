...
import { GRACE_PERIOD_MS, getEnterpriseLicense } from "@/modules/license-check/lib/license";
        ...
        <div>
          <div className="relative isolate mt-8 overflow-hidden rounded-lg bg-slate-900 px-3 pt-8 shadow-2xl sm:px-8 md:pt-12 lg:flex lg:gap-x-10 lg:px-12 lg:pt-0">
            ...
            <div className="mx-auto text-center lg:mx-0 lg:flex-auto lg:py-16 lg:text-left">
              <h2 className="text-2xl font-bold text-white sm:text-3xl">
                {t("environments.settings.enterprise.unlock_the_full_power_of_continium_free_for_30_days")}
              </h2>
          ...
          <div className="mt-8 rounded-lg border border-slate-300 bg-slate-100 shadow-sm">
            <div className="p-8">
              ...
              <Button asChild>
                <Link
                  href="https://app.continium.com/s/clvupq3y205i5yrm3sm9v1xt5"
                  target="_blank"
