...
import { recheckLicenseAction } from "@/modules/license-check/actions";
import type { TLicenseStatus } from "@/modules/license-check/types/enterprise-license";
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="border-t border-slate-100 pt-4 text-sm text-slate-500">
          ...
          <a
            ...
            href="mailto:hola@continium.com">
            hola@continium.com
          </a>
        </p>
      </div>
