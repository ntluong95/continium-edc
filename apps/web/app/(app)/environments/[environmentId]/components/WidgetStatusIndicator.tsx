...
export const WidgetStatusIndicator = ({ environment }: WidgetStatusIndicatorProps) => {
  ...
  const stati = {
    notImplemented: {
      ...
      title: t("environments.workspace.app-connection.continium_sdk_not_connected"),
      subtitle: t("environments.workspace.app-connection.continium_sdk_not_connected_description"),
    },
    running: {
      icon: CheckIcon,
      title: t("environments.workspace.app-connection.receiving_data"),
      subtitle: t("environments.workspace.app-connection.continium_sdk_connected"),
    },
  };
