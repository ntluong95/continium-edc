...
import { TResponseFilterCriteria } from "@continium/types/responses";
import { TSurveyElement, TSurveyElementTypeEnum } from "@continium/types/surveys/elements";
import { TSurvey, TSurveySummary } from "@continium/types/surveys/types";
import { getQuotasSummary } from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/lib/survey";
...
vi.mock("@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/lib/survey", () => ({
