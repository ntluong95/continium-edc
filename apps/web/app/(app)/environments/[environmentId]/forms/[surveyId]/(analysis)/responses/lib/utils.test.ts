...
describe("utils", () => {
  ...
  describe("getResponseSourceLabel", () => {
    test("maps known response sources to user-facing labels", () => {
      expect(getResponseSourceLabel("clinical_data_entry")).toBe("Clinical Data Entry");
      expect(getResponseSourceLabel("web")).toBe("Website");
      expect(getResponseSourceLabel("app")).toBe("App");
      expect(getResponseSourceLabel("link")).toBe("Survey Link");
      expect(getResponseSourceLabel(undefined)).toBe("Survey Link");
    });
  });
});
