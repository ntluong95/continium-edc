...
import { TResponseDataValue, TResponseTableData, TResponseWithQuotas } from "@continium/types/responses";
...
import { ResponseTable } from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/responses/components/ResponseTable";
