...
import { TResponseTableData } from "@continium/types/responses";
...
export const generateResponseTableColumns = (
          ...
          <Tooltip>
            ...
            <TooltipContent side="bottom" className="space-x-1 font-normal">
              ...
              <Link
                ...
                href="https://continium.com/docs/app-surveys/user-identification"
                target="_blank"
  ...
  const sourceColumn: ColumnDef<TResponseTableData> = {
    accessorKey: "source",
    size: 180,
    header: () => <div className="gap-x-1.5">{t("environments.surveys.responses.source")}</div>,
    cell: ({ row }) => (
      <span className="inline-flex rounded-full bg-slate-100 px-2 py-1 text-xs font-medium text-slate-700">
        {getResponseSourceLabel(row.original.meta.source)}
      </span>
    ),
  };
