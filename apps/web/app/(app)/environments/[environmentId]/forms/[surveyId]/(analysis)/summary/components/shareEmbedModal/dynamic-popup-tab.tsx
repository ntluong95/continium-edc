  ...
  return (
    <div className="flex h-full flex-col justify-between space-y-4" data-testid="dynamic-popup-container">
      <Alert variant="info" size="default">
        ...
        <AlertButton asChild>
          <Link href={`/environments/${environmentId}/forms/${surveyId}/edit`}>
        ...
        links={[
          {
            ...
            href: "https://continium.com/docs/xm-and-surveys/forms/website-app-surveys/advanced-targeting",
          },
          {
            title: t("environments.surveys.share.dynamic_popup.code_no_code_triggers"),
            href: "https://continium.com/docs/xm-and-surveys/forms/website-app-surveys/actions",
          },
          {
            title: t("environments.surveys.share.dynamic_popup.recontact_options"),
            href: "https://continium.com/docs/xm-and-surveys/forms/website-app-surveys/recontact",
          },
        ]}
      />
    </div>
