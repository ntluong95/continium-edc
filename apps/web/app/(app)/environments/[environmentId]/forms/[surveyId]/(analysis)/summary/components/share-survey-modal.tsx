...
import { TSegment } from "@continium/types/segment";
import { TSurvey } from "@continium/types/surveys/types";
import { TUser } from "@continium/types/user";
import { AnonymousLinksTab } from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/components/shareEmbedModal/anonymous-links-tab";
import { AppTab } from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/components/shareEmbedModal/app-tab";
import { CustomHtmlTab } from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/components/shareEmbedModal/custom-html-tab";
import { DynamicPopupTab } from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/components/shareEmbedModal/dynamic-popup-tab";
import { EmailTab } from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/components/shareEmbedModal/email-tab";
import { LinkSettingsTab } from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/components/shareEmbedModal/link-settings-tab";
import { PersonalLinksTab } from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/components/shareEmbedModal/personal-links-tab";
import { PrettyUrlTab } from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/components/shareEmbedModal/pretty-url-tab";
import { QRCodeTab } from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/components/shareEmbedModal/qr-code-tab";
import { SocialMediaTab } from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/components/shareEmbedModal/social-media-tab";
import { TabContainer } from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/components/shareEmbedModal/tab-container";
import { WebsiteEmbedTab } from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/components/shareEmbedModal/website-embed-tab";
import {
  LinkTabsType,
  ShareSettingsType,
  ShareViaType,
} from "@/app/(app)/environments/[environmentId]/forms/[surveyId]/(analysis)/summary/types/share";
...
export const ShareSurveyModal = ({
  ...
  const linkTabs = useMemo(() => {
    ...
    // Filter out tabs that should not be shown on Continium Cloud
    return isContiniumCloud
      ? tabs.filter(
