...
import { TResponseMeta } from "@continium/types/responses";
...
export const getResponseSourceLabel = (source?: string) => {
  switch (source) {
    case "clinical_data_entry":
      return "Clinical Data Entry";
    case "app":
      return "App";
    case "web":
    case "website":
...
export const METADATA_FIELDS = ["action", "country", ...userAgentFields, "url"];
