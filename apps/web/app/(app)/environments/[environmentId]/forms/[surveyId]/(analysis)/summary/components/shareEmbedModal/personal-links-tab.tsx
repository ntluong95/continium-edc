  ...
  if (!isContactsEnabled) {
    return (
      <UpgradePrompt
        ...
        buttons={[
          {
            text: isContiniumCloud ? t("common.upgrade_plan") : t("common.request_trial_license"),
            href: isContiniumCloud
        ...
        links={[
          {
            ...
            href: "https://continium.com/docs/xm-and-surveys/surveys/website-app-surveys/advanced-targeting#segment-configuration",
          },
        ]}
      />
    </div>
