      ...
      if (createProjectResponse?.data) {
        ...
        if (productionEnvironment) {
          if (globalThis.window !== undefined) {
            // Remove filters when creating a new project
            localStorage.removeItem(CONTINIUM_SURVEYS_FILTERS_KEY_LS);
          }
        }
        if (createProjectResponse.data.kind === "CLINICAL") {
          router.push(`/environments/${productionEnvironment?.id}/clinical-onboarding`);
        } else if (channel === "app" || channel === "website") {
