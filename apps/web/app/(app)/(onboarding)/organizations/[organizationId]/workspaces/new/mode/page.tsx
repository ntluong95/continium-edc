...
const Page = async (props: ModePageProps) => {
  ...
  const channelOptions = [
    {
      title: t("organizations.workspaces.new.mode.continium_surveys"),
      description: t("organizations.workspaces.new.mode.continium_surveys_description"),
      icon: ListTodoIcon,
      href: `/organizations/${params.organizationId}/workspaces/new/channel`,
    },
    {
      title: t("organizations.workspaces.new.mode.continium_cx"),
      description: t("organizations.workspaces.new.mode.continium_cx_description"),
      icon: HeartIcon,
