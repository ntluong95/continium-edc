...
import { TSurveyCreateInput } from "@continium/types/surveys/types";
import { TXMTemplate } from "@continium/types/templates";
...
export const XMTemplateList = ({ project, user, environmentId }: XMTemplateListProps) => {
  ...
  const createSurvey = async (activeTemplate: TXMTemplate) => {
    ...
    if (createSurveyResponse?.data) {
      router.push(`/environments/${environmentId}/forms/${createSurveyResponse.data.id}/edit?mode=cx`);
    } else {
