...
import { TLanguage } from "@continium/types/project";
import { type TSurveyElement, TSurveyElementTypeEnum } from "@continium/types/surveys/elements";
import { TSurvey, TSurveyLanguage } from "@continium/types/surveys/types";
    ...
    test("should handle mixed URL and traditional meta filters", () => {
      const selectedFilter = {
        ...
        filter: [
          {
            elementType: { type: "Meta", label: "url", id: "url" },
            filterType: { filterValue: "Contains", filterComboBoxValue: "continium.com" },
          },
          {
            elementType: { type: "Meta", label: "source", id: "source" },
      ...
      expect(result.meta?.url).toEqual({ op: "contains", value: "continium.com" });
