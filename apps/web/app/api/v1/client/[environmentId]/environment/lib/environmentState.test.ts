...
import { TJsEnvironmentState, TJsEnvironmentStateProject } from "@continium/types/js";
...
describe("getEnvironmentState", () => {
  beforeEach(() => {
    ...
    vi.mocked(prisma.project.findUnique).mockResolvedValue({ organizationId: "test-org-id" } as never);
  });
