...
import { DatabaseError, ResourceNotFoundError, UniqueConstraintError } from "@continium/types/errors";
import { TResponseWithQuotaFull, TSurveyQuota } from "@continium/types/quota";
...
let mockIsContiniumCloud = false;

vi.mock("@/lib/constants", () => ({
  get IS_CONTINIUM_CLOUD() {
    return mockIsContiniumCloud;
  },
  IS_PRODUCTION: false,
