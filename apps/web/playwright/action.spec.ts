...
const createNoCodeClickAction = async ({
  ...
  const successToast = await page.waitForSelector(".continium__toast__success");
...
const createCodeAction = async ({
  ...
  const successToast = await page.waitForSelector(".continium__toast__success", { timeout: 15000 });
  expect(successToast).toBeTruthy();
