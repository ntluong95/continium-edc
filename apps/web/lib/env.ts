...
import { z } from "zod";
import { AI_PROVIDERS } from "@continium/types/ai";
...
const parsedEnv = createEnv({
  ...
  server: {
    ...
    SIGNUP_ENABLED: z.enum(["1", "0"]).optional(),
    ENCRYPTION_KEY: z.string(),
    CONTINIUM_LICENSE_SERVER_URL: z.string().url().optional(),
    ...
    IS_CONTINIUM_CLOUD: z.enum(["1", "0"]).optional(),
  ...
  runtimeEnv: {
    ...
    CONTINIUM_LICENSE_SERVER_URL: process.env.CONTINIUM_LICENSE_SERVER_URL,
    ...
    IS_CONTINIUM_CLOUD: process.env.IS_CONTINIUM_CLOUD,
