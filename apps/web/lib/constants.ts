...
export const IS_CONTINIUM_CLOUD = env.IS_CONTINIUM_CLOUD === "1";
// Alias used by integration pages that were ported from Formbricks
export const IS_FORMBRICKS_CLOUD = IS_CONTINIUM_CLOUD;
...
export const SAML_TENANT = "continium.com";
export const SAML_PRODUCT = "continium";
...
export const IS_STORAGE_CONFIGURED = true; // S3 when configured, falls back to Prisma DB
