import type { TOrganizationStripeSubscriptionStatus } from "@continium/types/organizations";
...
export type TOrganizationEntitlementsContext = {
  ...
  licenseStatus: TContiniumLicenseStatus;
  licenseFeatures: TContiniumLicenseFeatures | null;
