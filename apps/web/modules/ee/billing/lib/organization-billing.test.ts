...
vi.mock("@/lib/constants", async (importOriginal) => {
  ...
  return {
    ...actual,
    get IS_CONTINIUM_CLOUD() {
      return mocks.isCloud;
    },
  };
});

vi.mock("@continium/cache", () => ({
  createCacheKey: {
    organization: {
...
describe("organization-billing", () => {
    ...
    mocks.productsRetrieve.mockImplementation(async (productId: string) => ({
      ...
      metadata:
        productId === "prod_hobby"
          ? { continium_plan: "hobby" }
          : productId === "prod_pro"
            ? { continium_plan: "pro" }
            : productId === "prod_scale"
              ? { continium_plan: "scale" }
              : {},
    }));
      ...
      data: [
        {
          ...
          metadata: {
            continium_plan: "hobby",
            continium_price_kind: "base",
            continium_interval: "monthly",
          },
          recurring: { usage_type: "licensed", interval: "month" },
          product: { id: "prod_hobby", active: true, metadata: { continium_plan: "hobby" } },
        },
        {
          ...
          recurring: { usage_type: "licensed", interval: "month" },
          product: { id: "prod_pro", active: true, metadata: { continium_plan: "pro" } },
        },
        {
          id: "price_pro_yearly",
          active: true,
        ...
        },
        {
          ...
          metadata: {
            continium_plan: "pro",
            continium_price_kind: "responses",
            continium_interval: "monthly",
          },
        ...
        },
        {
          ...
          recurring: { usage_type: "licensed", interval: "month" },
          product: { id: "prod_scale", active: true, metadata: { continium_plan: "scale" } },
        },
        {
            ...
            data: [
              {
                price: {
                  metadata: {},
                  product: { id: "prod_pro", metadata: { continium_plan: "pro" } },
                  recurring: { usage_type: "licensed", interval: "year" },
                },
              },
            ],
            ...
            data: [
              {
                ...
                price: {
                  ...
                  product: { id: "prod_pro", metadata: { continium_plan: "pro" }, active: true },
                  recurring: { usage_type: "licensed", interval: "month" },
                },
              },
              {
            ...
            data: [
              {
                ...
                price: {
                  ...
                  product: { id: "prod_scale", metadata: { continium_plan: "scale" }, active: true },
                  recurring: { usage_type: "licensed", interval: "month" },
                },
              },
              {
            ...
            data: [
              {
                price: {
                  metadata: {},
                  product: { id: "prod_scale", metadata: { continium_plan: "scale" } },
                  recurring: { usage_type: "licensed", interval: "month" },
                },
              },
            ],
  ...
  test("syncOrganizationBillingFromStripe prefers higher-tier active subscription over hobby", async () => {
    mocks.getCloudPlanFromProduct.mockImplementation(
      (product: { metadata?: { continium_plan?: string } }) => {
        if (product.metadata?.continium_plan === "hobby") return "hobby";
        if (product.metadata?.continium_plan === "pro") return "pro";
        return "unknown";
      }
    );
    mocks.prismaOrganizationBillingFindUnique.mockResolvedValue({
            ...
            data: [
              {
                price: {
                  metadata: {},
                  product: { id: "prod_hobby", metadata: { continium_plan: "hobby" } },
                  recurring: { usage_type: "licensed", interval: "month" },
                },
              },
            ],
