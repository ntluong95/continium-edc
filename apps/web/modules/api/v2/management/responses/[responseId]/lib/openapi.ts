...
import { ZResponseUpdateInput } from "@continium/types/responses";
...
export const updateResponseEndpoint: ZodOpenApiOperationObject = {
  ...
  description:
    "Updates a response in the database. This will trigger the response pipeline, including follow-up emails (if the response is marked as finished) and other configured actions.",
  tags: ["Management API - Responses"],
  requestParams: {
    path: z.object({
      id: ZResponseIdSchema,
