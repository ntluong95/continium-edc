...
import { TSurveyStyling } from "@continium/types/surveys/types";
            ...
            <div className={`${baseClasses} ${loadedClass} bg-cover bg-center`}>
              ...
              {authorDetailsForUnsplash.authorName && (
                <div className="absolute bottom-4 right-6 z-10 ml-auto hidden w-max text-xs text-slate-400 md:block">
                  ...
                  <Link
                    href={authorDetailsForUnsplash.authorURL + "?utm_source=continium&utm_medium=referral"}
                    target="_blank"
                  ...
                  <Link
                    href="https://unsplash.com/?utm_source=continium&utm_medium=referral"
                    target="_blank"
                    className="hover:underline">
                    Unsplash
                  </Link>
