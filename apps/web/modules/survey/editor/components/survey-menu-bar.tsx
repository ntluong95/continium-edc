...
import { getLanguageLabel } from "@continium/i18n-utils/src/utils";
...
export const SurveyMenuBar = ({
  ...
  const handleSurveyPublish = async () => {
    ...
    try {
      ...
      isSuccessfullySavedRef.current = true;
      router.push(`/environments/${environmentId}/forms/${localSurvey.id}/summary?success=true`);
    } catch (error) {
      console.error(error);
            ...
            <Alert variant="warning" size="small">
              ...
              <AlertButton className="flex items-center justify-center">
                <a
                  ...
                  href="https://continium.com/docs/self-hosting/configuration/file-uploads"
                  target="_blank"
