...
import type { TSurveyElement, TSurveyFileUploadElement } from "@continium/types/surveys/elements";
...
export const FileUploadElementForm = ({
  ...
  const handleMaxSizeInMBToggle = (checked: boolean) => {
    const defaultMaxSizeInMB = isContiniumCloud ? maxSizeInMBLimit : 1024;
            ...
            <p className="text-sm font-semibold text-slate-700">
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  if (isContiniumCloud && parsedValue > maxSizeInMBLimit) {
                    toast.error(
