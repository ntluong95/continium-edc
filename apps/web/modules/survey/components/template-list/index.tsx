...
import { ZProjectConfigChannel, ZProjectConfigIndustry } from "@continium/types/project";
import { TSurveyCreateInput, TSurveyType } from "@continium/types/surveys/types";
import { TTemplate, TTemplateFilter, ZTemplateRole } from "@continium/types/templates";
...
export const TemplateList = ({
  ...
  const createSurvey = async (activeTemplate: TTemplate) => {
    ...
    if (createSurveyResponse?.data) {
      router.push(`/environments/${environmentId}/forms/${createSurveyResponse.data.id}/edit`);
    } else {
