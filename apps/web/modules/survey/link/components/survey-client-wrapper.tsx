...
import { TProjectStyling } from "@continium/types/project";
import { TResponseData } from "@continium/types/responses";
import { TSurvey, TSurveyStyling } from "@continium/types/surveys/types";
  ...
  return (
    <>
      ...
      <LinkSurveyWrapper
        ...
        IS_CONTINIUM_CLOUD={IS_CONTINIUM_CLOUD}
