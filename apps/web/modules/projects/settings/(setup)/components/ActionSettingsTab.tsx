...
import { TActionClass, TActionClassInput } from "@continium/types/action-classes";
...
export const ActionSettingsTab = ({
  ...
  const actionDocsHref = "https://continium.com/docs/xm-and-surveys/surveys/website-app-surveys/actions";
