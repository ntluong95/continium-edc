...
const getLatestStableFbRelease = async (): Promise<string | null> => {
  try {
    const res = await fetch("https://api.github.com/repos/continium/continium/releases/latest");
    ...
    throw new Error("Failed to get latest stable Continium release", { cause: error });
  }
};
