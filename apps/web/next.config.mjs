...
const nextConfig = {
  ...
  turbopack: {},
  experimental: {},
  transpilePackages: ["@continium/database"],
  images: {
    ...
    remotePatterns: [
      ...
      {
        protocol: "https",
        hostname: "app.continium.com",
      },
      {
        protocol: "https",
        hostname: "continium-cdn.s3.eu-central-1.amazonaws.com",
      },
      {
        protocol: "https",
  ...
  async rewrites() {
    ...
    return [
      ...posthogRewrites,
      {
        ...
        destination: "/js/continium.umd.cjs",
      },
      {
