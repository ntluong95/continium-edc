...
![Survey UI Preview](https://cdn.jsdelivr.net/gh/continium/continium@main/packages/survey-ui/images/survey-preview.png)

## Installation

```bash
npm install @continium/survey-ui
```
...
```tsx
import { OpenText, Rating } from "@continium/survey-ui";
import "@continium/survey-ui/styles";
...
} from "@continium/survey-ui";
```

## License

MIT — [Continium](https://continium.com)
