...
export const EXPECTED_ERROR_NAMES = new Set([
  ...
  "InvalidPasswordResetTokenError",
  "UniqueConstraintError",
  // Thrown by @continium/licensing's assertContiniumFeatureEnabled.
  // Listed here so next-safe-action's actionClient converts it to a
  // structured action result instead of a Sentry 500. The class is
  // defined in packages/continium-licensing; we match by name to avoid
  // a circular dep between @continium/types and @continium/licensing.
