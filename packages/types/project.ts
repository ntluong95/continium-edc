...
export const ZProjectConfigIndustry = z.enum(["clinicalTrial", "registryCohort", "other"]).nullable();
...
/** Distinguishes standard product-survey projects from regulated clinical EDC projects. */
