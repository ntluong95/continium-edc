...
const fbLogoUrl = "https://app.continium.com/logo-transparent.png";
const logoLink = "https://continium.com?utm_source=email_header&utm_medium=email";
        ...
        <Body
          ...
          <Section className="mt-4 text-center text-sm">
            <Link
              ...
              href="https://continium.com/?utm_source=email_header&utm_medium=email"
              target="_blank"
