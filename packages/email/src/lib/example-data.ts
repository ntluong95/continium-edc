...
export const exampleData = {
  verificationEmail: {
    verifyLink: "https://app.continium.com/auth/verify?token=example-verification-token",
    verificationRequestLink: "https://app.continium.com/auth/verification-requested",
  },

  forgotPasswordEmail: {
    verifyLink: "https://app.continium.com/auth/forgot-password/reset?token=example-reset-token",
    linkValidityInMinutes: 30,
  },

  newEmailVerification: {
    verifyLink: "https://app.continium.com/verify-email-change?token=example-email-change-token",
  },
  ...
  inviteEmail: {
    ...
    verifyLink: "https://app.continium.com/invite?token=example-invite-token",
  },
  ...
  linkSurveyEmail: {
    ...
    surveyLink:
      "https://app.continium.com/s/example-survey-id?verify=example-token&suId=example-single-use-id",
  },
  ...
  responseFinishedEmail: {
    ...
    WEBAPP_URL: "https://app.continium.com",
  ...
  legalProps: {
    privacyUrl: "https://continium.com/privacy",
    termsUrl: "https://continium.com/terms",
    imprintUrl: "https://continium.com/imprint",
    imprintAddress: "Continium GmbH, Example Street 123, 12345 Berlin, Germany",
  },
};
