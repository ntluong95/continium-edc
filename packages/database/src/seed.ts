...
const KITCHEN_SINK_QUESTIONS: SurveyQuestion[] = [
  {
    id: createId(),
    type: "openText",
    headline: { default: "What do you think of Continium?" },
  ...
  },
  {
    ...
    headline: { default: "How often do you use Continium?" },
    required: true,
    choices: [
  ...
  },
  {
    id: createId(),
    type: "nps",
    headline: { default: "How likely are you to recommend Continium?" },
    required: true,
  ...
  },
  {
    ...
    buttonUrl: "https://continium.com/docs",
    buttonExternal: true,
  },
  {
    id: createId(),
  ...
  },
  {
    id: createId(),
    type: "date",
    headline: { default: "When did you start using Continium?" },
    required: true,
    format: "M-d-y",
  },
  {
