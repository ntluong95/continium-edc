import type { Iso639Code } from "@continium/i18n-utils";

/**
 * Native-script display names for every ISO 639 code Continium supports.
 *
 ...
 * @continium/i18n-utils via `as const satisfies`, so adding or removing a
 ...
 * @continium/i18n-utils that was previously bundled.
 */
