...
const DB_NAME = "continium-offline";
const DB_VERSION = 1;
...
const openDb = (): Promise<IDBDatabase> => {
  ...
  dbPromise = new Promise((resolve, reject) => {
    ...
    request.onblocked = () => {
      console.warn("Continium: IndexedDB open blocked by another connection");
    };
...
export const addPendingResponse = async (entry: Omit<PendingResponseEntry, "id">): Promise<number> => {
  try {
    ...
    console.warn("Continium: Failed to persist response to IndexedDB", e);
    return -1;
  }
};
...
export const getPendingResponses = async (surveyId: string): Promise<PendingResponseEntry[]> => {
  try {
    ...
    console.warn("Continium: Failed to read pending responses from IndexedDB", e);
    return [];
  }
};
...
export const removePendingResponse = async (id: number): Promise<void> => {
  try {
    ...
    console.warn("Continium: Failed to remove pending response from IndexedDB", e);
  }
};
...
export const countPendingResponses = async (surveyId: string): Promise<number> => {
  try {
    ...
    console.warn("Continium: Failed to count pending responses from IndexedDB", e);
    return 0;
  }
};
...
export const clearPendingResponses = async (surveyId: string): Promise<void> => {
  try {
    ...
    console.warn("Continium: Failed to clear pending responses from IndexedDB", e);
  }
};
...
export const saveSurveyProgress = async (progress: SurveyProgressEntry): Promise<void> => {
  try {
    ...
    console.warn("Continium: Failed to save survey progress to IndexedDB", e);
  }
};
...
export const getSurveyProgress = async (surveyId: string): Promise<SurveyProgressEntry | undefined> => {
  try {
    ...
    console.warn("Continium: Failed to read survey progress from IndexedDB", e);
    return undefined;
  }
};
...
export const patchSurveyProgressSnapshot = async (
  ...
  try {
    ...
    console.warn("Continium: Failed to patch survey progress snapshot in IndexedDB", e);
  }
};
...
export const clearSurveyProgress = async (surveyId: string): Promise<void> => {
  try {
    ...
    console.warn("Continium: Failed to clear survey progress from IndexedDB", e);
  }
};
