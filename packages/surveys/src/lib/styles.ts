...
import surveyUiCss from "@continium/survey-ui/styles?inline";
...
export const setStyleNonce = (nonce: string | undefined): void => {
  ...
  const existingStyleElement = document.getElementById("continium__css");
  if (existingStyleElement && nonce) {
    existingStyleElement.setAttribute("nonce", nonce);
  }

  const existingCustomStyleElement = document.getElementById("continium__css__custom");
...
export const addStylesToDom = () => {
  if (document.getElementById("continium__css") === null) {
    const styleElement = document.createElement("style");
    styleElement.id = "continium__css";
...
export const addCustomThemeToDom = ({ styling }: { styling: TProjectStyling | TSurveyStyling }): void => {
  ...
  let styleElement = document.getElementById("continium__css__custom") as HTMLStyleElement | null;
  ...
  if (styleElement) {
    ...
    styleElement.id = "continium__css__custom";
