...
import { FileUpload, type UploadedFile } from "@continium/survey-ui";
...
import type { TSurveyFileUploadElement } from "@continium/types/surveys/elements";
...
export function FileUploadElement({
  ...
  const convertToUploadedFiles = (urls: string[]): UploadedFile[] => {
    return urls.map((url) => {
      ...
      // Clean up Continium storage pattern: name--fid--uuid.ext
