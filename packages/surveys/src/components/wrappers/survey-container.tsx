...
import { type TOverlay, type TPlacement } from "@continium/types/common";
...
export function SurveyContainer({
  ...
  if (!isModal) {
    return (
      <div id="fbjs" className="continium-form" style={{ height: "100%", width: "100%" }} dir={dir}>
        {children}
      </div>
    );
  }
  ...
  return (
    <div id="fbjs" className="continium-form" dir={dir}>
      <div
        aria-live="assertive"
        className={cn(
