...
The `@continium/surveys` package provides a complete survey rendering system built with Preact/React. It features automated translation management through Lingo.dev.
...
- Access to the Continium team on Lingo.dev

### Step-by-Step Setup

1. **Join the Continium Team**
   - Join the Continium team on Lingo.dev
