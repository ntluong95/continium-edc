...
2. Clone the Continium repository and navigate to the docs folder:

```bash
git clone https://github.com/continium/continium.git
cd continium/docs
```
...
- For other issues, please check our [Contributing Guidelines](https://github.com/continium/continium/blob/main/CONTRIBUTING.md)
