...
Enabling the Airtable Integration in a self-hosted environment requires creating an airtable account and changing the environment variables of your Continium instance.
...
* Now just copy **Client ID** for your integration & add it to your **Continium environment variables** as in the docker compose file:

* `AIRTABLE_CLIENT_ID`

Voila! You have successfully enabled the Airtable integration in your self-hosted Continium instance. Now you can follow the steps mentioned in [Airtable Integration with Continium](/xm-and-surveys/core-features/integrations/airtable) section to link an Airtable with Continium.
