...
Setup your Zap: Go to [zapier.com](https://zapier.com/) and create a new Zap. Search for “Continium” to get started:
...
Connect Continium with Zapier: You have to connect Zapier with Continium via an API Key:
...
Voila! You have successfully configured Zapier to work with your self-hosted Continium instance. Now, you can follow the steps mentioned in the [Zapier Integration](https://continium.com/docs/developer-docs/integrations/zapier) section to connect it with your Continium app and see it live.
