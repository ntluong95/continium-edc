...
description: "Set up email functionality for your self-hosted Continium instance"
icon: "envelope"
---

By default, Continium doesn't include an SMTP server for sending emails. However, you can easily configure your self-hosted instance to use your own email provider through environment variables.

## Why Configure SMTP?

Setting up an SMTP server enables important email functionality in Continium, including:
...
Continium uses Nodemailer to send emails and supports various SMTP providers like:
...
By default, email verification and password reset features are **disabled** in Continium. To enable these features:
