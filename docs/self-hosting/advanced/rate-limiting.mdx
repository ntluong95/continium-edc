---
title: "Rate Limiting"
description: "Current request rate limits in Continium"
icon: "timer"
---

Continium applies request rate limits to protect against abuse and keep API usage fair.
...
| --- | --- | --- | --- |
| `/api/v1/management/*` (except `/api/v1/management/storage`), `/api/v1/management/me` | 100 requests | 1 minute | API key ID or session user ID |
...
| `api.v1` | 100 requests | 1 minute | API key ID or session user ID | v1 management and `/api/v1/management/me` |
