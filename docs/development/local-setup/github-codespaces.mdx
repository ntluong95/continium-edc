...
description: How to set up Continium in a GitHub Codespaces environment
icon: "github"
---

### GitHub Codespaces Setup

<Info>This guide outlines how to set up Continium in a **GitHub Codespaces** environment.</Info>
...
Use the Codespaces port forwarding to access Continium at [http://localhost:3000](http://localhost:3000).
