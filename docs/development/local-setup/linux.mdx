---
title: Linux
description: How to set up Continium on a Linux machine
icon: "linux"
---

### Local Machine Setup - Linux

<Info>This guide is recommended for advanced users setting up Continium on a **Linux** machine.</Info>

Here are the requirements for setting up Continium on Linux:
...
You can now access Continium at [http://localhost:3000](http://localhost:3000).
