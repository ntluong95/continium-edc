---
title: "Contribute to Continium"
description: "How to contribute to Continium"
icon: "code"
---

We’re excited that you want to contribute to Continium! There are many ways to help, including reporting issues, fixing bugs, adding new features, or improving documentation.
...
We highly recommend engaging with us on [**GitHub Discussions**](https://github.com/continium/continium/discussions) before submitting contributions.
This helps improve the chances of your PR being accepted while avoiding unnecessary work.

#### Contributor License Agreement (CLA)

To keep Continium sustainable, we require a **CLA** from all contributors.
