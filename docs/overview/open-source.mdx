...
The open core of the Continium software is available under the AGPLv3 license. This means you can use, modify, and distribute the software as long as you adhere to the [terms of the license.](https://www.tldrlegal.com/license/gnu-affero-general-public-license-v3-agpl-3-0) The open-source version of Continium is free to use, even for commercial purposes. Over time, all survey features will remain part of the free Community Edition.

Continium also offers a more advanced Enterprise Edition with additional features and support.
