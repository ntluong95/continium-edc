...
description: "Understand organization-level roles and how they control access to teams, projects, and data across your Continium organization."
icon: "building"
---

Organization-level roles apply to all teams and projects within your Continium organization. These roles provide broad permissions that determine what users can do across the entire organization.
