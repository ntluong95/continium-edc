...
Add new members to your Continium organization to collaborate on surveys and manage projects together. You can invite members individually or in bulk using CSV uploads.
...
1. Continium sends an email to the organization member with an invitation link
...
- Continium sends an email to each organization member in the CSV
