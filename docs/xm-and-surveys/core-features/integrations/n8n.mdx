...
Go to [n8n.io](https://n8n.io) and create a new workflow. Search for “Continium” to get started:

![Add Continium Trigger](/images/xm-and-surveys/core-features/integrations/n8n/add-continium-trigger.webp)

## Step 3: Connect Continium with n8n

Now, you have to connect n8n with Continium via an API Key:
