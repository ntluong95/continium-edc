---
title: "Wordpress"
description: "Target specific visitors with a survey on your WordPress page using Continium for free. Show survey on specific page or on button click."
---

To run a targeted survey on your WordPress website, Continium is the way to go!&#x20;
...
1. Install the Continium WordPress plugin

2. Create a [free Continium account](https://app.continium.com/auth/signup)
...
## Step 1: Install the Continium WordPress plugin

As long as the Continium plugin is in review, please download it from our [GitHub repository directly.](https://github.com/continium/wordpress)
...
## Step 2: Create a Continium Account

This is super straight forward: Go to [app.continium.com/auth/signup](https://app.continium.com/auth/signup), create the account, verify your email and you’re in!
...
In your WordPress instance, go to the Continium Plugin settings and copy the environmentId in the correct field:
...
If you have any questions or need help, feel free to reach out to us on [Github Discussions](https://github.com/continium/continium/discussions)
