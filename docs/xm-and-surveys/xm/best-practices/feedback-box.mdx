---
title: "Feedback Box"
description: "A step-by-step guide to creating a feedback box using Continium."
icon: "box"
---
...
1. Create new Feedback Box at app.continium.com
...
Then, create a new survey and look for the [Feedback Box template](https://continium.com/survey-templates/feedback-box):
...
<Note>Continium Widget running? You need to have the Continium Widget installed to display the Feedback Box in your app. Please follow [this tutorial (Step 4 onwards)](/xm-and-surveys/surveys/website-app-surveys/quickstart) to install the widget.</Note>