...
title: "Contact form"
icon: "address-book"
description: "A step-by-step guide to creating a contact form using Continium."
---

Welcome to this comprehensive guide on creating a contact form using Continium. Whether you're just starting out or you're a seasoned developer, this tutorial will walk you through every step of building an engaging and effective contact form.
...
![Adding a question in Continium](/images/xm-and-surveys/xm/best-practices/contact-form/add-question.webp)
...
- Enable submission notifications:
   ...
   * Go to your Continium account settings.
...
![Embed Image configuration](/images/xm-and-surveys/xm/best-practices/contact-form/embed.webp)
   ...
   * Find your form in the Continium dashboard, and click Share.
...
Congratulations! You’ve successfully created and integrated a professional contact form using Continium. This form will help you collect valuable information from your visitors in an efficient, user-friendly way.
