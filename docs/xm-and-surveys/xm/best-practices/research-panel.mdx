...
description: "Build and manage your own research panel using Continium to collect profiling data, create targeted segments, and distribute personalized survey links to panel members."
...
Continium provides all the tools you need to build and manage a research panel:
...
<Steps>
  <Step title="Create a profiling survey">
    ...
    1. Go to [app.continium.com](https://app.continium.com) and click **Create Survey**
  ...
  <Step title="Download the example contact upload CSV">
    ...
    The example CSV shows you the format Continium expects for contact uploads, including required fields like email and optional attribute columns.
  </Step>
  ...
  <Step title="Upload contacts to Continium">
    Import your panel members into Continium:
    ...
    Your panel members are now stored in Continium with their profiling attributes.
  </Step>
