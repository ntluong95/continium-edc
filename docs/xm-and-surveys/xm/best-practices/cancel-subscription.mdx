...
description: "Mastering Churn Surveys with Continium | Essential Tips & Steps"
...
1. Create new Churn Survey at [app.continium.com](https://app.continium.com/)
...
<Note>
  ### Continium Widget running? We assume that you have already installed the

  Continium Widget in your web app. It’s required to display messages and
...
Click on "Create Survey" and choose the template [Churn Survey](https://continium.com/survey-templates/churn-survey):
