...
1. Create new Interview Prompt at [app.continium.com](https://app.continium.com/)
...
<Note>
  Continium Widget running? We assume that you have already installed the Continium Widget in your web app. It’s required to display messages and surveys in your app. If not, please follow the [Quick Start Guide (15mins)](/xm-and-surveys/surveys/website-app-surveys/quickstart)
</Note>
...
Click on "Create Survey" and choose the template [Interview Prompt](https://continium.com/survey-templates/interview-prompt):
