---
title: "Understanding Continium Survey Types"
sidebarTitle: "Survey Types 101"
description: "This guide explains the differences between Continium Link Surveys and Website & App Surveys to help you choose the right option."
...
| **Segmentation** | You control externally | Built-in via Continium |
...
```
https://app.continium.com/s/<surveyId>?embed=true&userId=123
```
...
window.addEventListener("message", (event) => {
  if (event.data === "continiumSurveyCompleted") {
    closeWebView();
  }
});
```
...
- You don't need Continium attribute-based targeting & survey fatigue controls


## Website & App Surveys (SDK)

Also known as **intercept surveys**. Requires SDK integration. Continium handles targeting, triggering, and survey fatigue.
...
- You want Continium to handle who sees which survey
...
**Need help?** [Join us in GitHub Discussions](https://github.com/continium/continium/discussions)
