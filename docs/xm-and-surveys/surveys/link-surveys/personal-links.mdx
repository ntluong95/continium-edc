...
| Column | Description |
|--------|-------------|
| **Continium Contact ID** | Internal contact identifier (`contactId`) |
...
- **CSV storage**: Generated link lists are not retained in Continium - download and store your CSV files securely
