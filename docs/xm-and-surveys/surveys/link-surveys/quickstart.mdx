...
<Steps>
  <Step title="Create a free Continium Cloud account">
    While you can [self-host](/self-hosting/overview) Continium, the quickest and easiest way to get started is with the free Cloud plan. Just [sign up here](https://app.continium.com/auth/signup) and click through the onboarding.
  ...
  <Step title="Configure your survey settings">
    Continium packs a lot of useful functionality out of the box. You can:
