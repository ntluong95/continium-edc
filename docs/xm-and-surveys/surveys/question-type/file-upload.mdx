...
<Note>
  **Self-Hosting Requirements**: This question type requires file upload storage to be configured. If you're
  self-hosting Continium, make sure to [configure file uploads](/self-hosting/configuration/file-uploads)
  before using this feature.
</Note>

<iframe
  title="Survey Embed"
  src="https://app.continium.com/s/oo4e6vva48w0trn01ht8krwo"
  style={{
    position: "relative",
    height: "600px",
    maxHeight: "100vh",
