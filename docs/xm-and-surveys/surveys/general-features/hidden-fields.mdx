...
```
https://continium.com/s/clin34bjy?screen=pricing
```

Multiple Hidden Fields:

```
https://continium.com/s/clin34bjy?screen=landing_page&job=Founder
```
...
```js
continium.track("action_name", {hiddenFields: {myField: "value"}})
```
